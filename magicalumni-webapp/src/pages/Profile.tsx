    ...
    const fetchData = async () => {
      try {
        ...
        const collegeResponse = await fetch(
          'http://localhost:3000/api/colleges/collegedetail',
          {
            method: 'POST',
            headers: {
        ...
        if (collegeData.status === 'ok') {
          console.log(collegeData.collegeList);
          setUserName(collegeData.collegeList.name);
          setCity(collegeData.collegeList.city);
          setAddress(collegeData.collegeList.address);
          setDescription(collegeData.collegeList.description);
        } else {
          console.error(collegeData.message);
        }
        ...
        if (unApprovedMemberData.status === 'ok') {
          ...
          setTotalMembers(unApprovedMemberData.memberPeopleCountOff.toString());
        } else {
          console.error(unApprovedMemberData.message);
        }

        const jobResponse = await fetch(
          'http://localhost:3000/api/job/jobsCount',
          {
            method: 'POST',
            headers: {
              'Content-Type': 'application/json',
        ...
        if (jobResponseData.status === 'ok') {
          console.log(jobResponseData.jobsCountOff);
          setJobCount(jobResponseData.jobsCountOff.toString());
        } else {
      ...
      <div className="overflow-hidden rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
        ...
        <div className="px-4 pb-6 text-center lg:pb-8 xl:pb-11.5">
          ...
          <div className="mt-4">
            ...
            <p className="font-medium">{city || 'Loading...'}</p>
            ...
            <div className="mx-auto max-w-180">
              ...
              <p className="mt-4.5">{description || 'Loading...'}</p>
            </div>
            &nbsp;
            <div className="mx-auto max-w-180">
              <h4 className="font-semibold text-black dark:text-white">
              ...
              <p className="mt-4.5">{address || 'Loading...'}</p>
            </div>
